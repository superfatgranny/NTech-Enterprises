...
local function updateFixedStep(dt)
    ...
    --Run the waste gate to match camsoEngine pressureMap targets
    wastegateTargetBoost = assignedEngine.wastegateTarget
    ...
    local pascalToBar = 1e-5
    assignedEngine.inductionPressure = turboPressure * pascalToBar + 1.0
    ...
    assignedEngine.forcedInductionInfoStream.rpm = curTurboAV * avToRPM
    assignedEngine.forcedInductionInfoStream.coef = assignedEngine.forcedInductionCoef
    --forcedInductionInfoStream.exhaustPower = exhaustPower / dt
    --forcedInductionInfoStream.backpressure = backPressure / dt
    assignedEngine.forcedInductionInfoStream.bovEngaged = (bovEngaged and 1 or 0) * 10
    assignedEngine.forcedInductionInfoStream.wastegateFactor = wastegateFactor * 10
    assignedEngine.forcedInductionInfoStream.turboTemp = turboTemp
end
